/*implementação de selection sort em c*/

#include <stdio.h>

int menor_numero (int vetor[], int posicao, int tamanho);
...
void ordenar_vetor (int vetor[], int tamanho)
{
    ...
    {
        int menor = menor_numero(vetor, i, tamanho);
        troca_valores(&vetor[i], &vetor[menor]);
    }
...
//identifica a posição do menor número
int menor_numero (int vetor[], int posicao, int tamanho)
{
    int menor = posicao; //remove o lixo de "menor"
